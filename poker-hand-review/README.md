...
### Step 2
- Hand generation now includes betting patterns for Villain (loose passive) and Hero (tight aggressive). See poker_drill_README.md for information on betting for those personalities.
